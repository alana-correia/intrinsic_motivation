...
def parse_args():
    ...
    parser.add_argument("--exp-name", type=str, default="brims_baseline",
    ...
    parser.add_argument("--wandb-project-name", type=str, default="CVPR_experiments",
...
if __name__ == "__main__":
    ...
    envs = gym.vector.SyncVectorEnv(
        [make_env(args.gym_id, args.seed + random.randint(0, 1000), i, args.frame_stack, args.capture_video, run_name)
         for i in
         range(args.num_envs)]
    )
