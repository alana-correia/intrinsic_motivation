...
- normalizar a reward
- introducao do contexto como input
'''
...
def parse_args():
    ...
    parser.add_argument("--run_name", type=str, default="BreakoutNoFrameskip-v4__cnn_brims_mlp_mlp_intrinsic_reward__1__1659217632",
